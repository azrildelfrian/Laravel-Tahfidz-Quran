        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="surat_id" id="surat_1" class="form-control"
                            onchange="updateAyatOptions(this, 'ayat_setoran_1')" required>
                            <option value="">Pilih Surat</option>
                            {{-- @foreach ($surat as $index => $item)
                                <option value="{{ $index }}">{{ $item['nama_surat'] }} - {{ $item['ayat'] }} ayat
                                </option>
                            @endforeach --}}
                            @foreach ($surat as $id => $item)
                                <option value="{{ $id }}">{{ $item['nama_surat'] }} - {{ $item['ayat'] }} ayat
                                </option>
                            @endforeach
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="surat_id_2" id="surat_2" class="form-control"
                        onchange="updateAyatOptions(this, 'ayat_setoran_2')" required>
                        <option value="">Pilih Surat</option>
                        @foreach ($surat as $id => $item)
                            <option value="{{ $id }}">{{ $item['nama_surat'] }} - {{ $item['ayat'] }} ayat
                            </option>
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_hafalan" id="file" accept="audio/mp3"
                        class="input100 form-control form-control-lg" required>
