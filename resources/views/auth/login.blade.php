            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">Kata Sandi/Password</label>
                ...
                <div class="text-center">
                  Lupa Password ? <a class="text-primary fw-bold" href="{{ url('/forgot-password') }}">Klik disini</a>
                </div>
              </div>
            </div>
          </div>
